...
#     - everything else   : plain pip (requirements-inference.txt, repo root)
#
# USAGE:
#   1. Start the box, SSH in. Copy this script and requirements-inference.txt (repo root) to the box.
...
#   box. requirements-inference.txt already excludes the non-headless build.
# ===========================================================================
