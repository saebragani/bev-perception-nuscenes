...
launcher = 'none'
load_from = 'checkpoints/centerpoint_0075voxel_second_secfpn_circlenms_4x8_cyclic_20e_nus_20220810_011659-04cb3a3b.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    backend_args=None,
    data_root='data/nuscenes/',
    jsonfile_prefix='results/centerpoint_0075voxel/preds',
    metric='bbox',
    type='NuScenesMetric')
test_pipeline = [
    dict(
...
work_dir = 'results/centerpoint_0075voxel'
