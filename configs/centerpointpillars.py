...
launcher = 'none'
load_from = 'checkpoints/centerpoint_02pillar_second_secfpn_circlenms_4x8_cyclic_20e_nus_20220811_031844-191a3822.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    backend_args=None,
    data_root='data/nuscenes/',
    jsonfile_prefix='results/centerpointpillars/preds',
    metric='bbox',
    type='NuScenesMetric')
test_pipeline = [
    dict(
...
work_dir = 'results/centerpointpillars'
